...
- [ ] T002 Validate repository naming and placement against constitution rules
- [ ] T003 Initialize [language] project with [framework] dependencies
- [ ] T004 [P] Configure linting and formatting tools
- [ ] T005 Add/verify run instructions, env requirements, and expected outputs in docs
...
- [ ] T006 Verify category boundaries (example/template/solved-task) for all changed paths
- [ ] T007 [P] If `mcp/` changed, validate at least one consumer workflow still works
- [ ] T008 [P] Document MCP compatibility impact and migration notes (when applicable)
